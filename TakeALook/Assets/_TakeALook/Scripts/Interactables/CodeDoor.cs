...
public class CodeDoor : MonoBehaviour
{
    ...
    [Tooltip("Si est� activado, la puerta seguir� desbloqueada aunque cambies de escena o reinicies el juego.")]
    ...
    [Tooltip("Activa esto SOLO en la puerta final. Las dem�s puertas deben tenerlo desactivado.")]
    [SerializeField] bool warpOnCorrectCode = false;

    [Tooltip("Escena a la que ir� cuando esta puerta final acepte el c�digo.")]
    [SerializeField] string finalSceneName = "FinalDialogueScene";

    [Tooltip("Tiempo de espera despu�s de aceptar el c�digo antes de cambiar de escena.")]
